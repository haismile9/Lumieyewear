// LUMI Web - Data Source Router
// Switch between Backend API and Shopify API based on configuration

const dataSource = process.env.NEXT_PUBLIC_DATA_SOURCE || 'backend';
...
if (dataSource === 'backend') {
  ...
  // Use original Shopify implementation
  export * from './index-shopify';
}
